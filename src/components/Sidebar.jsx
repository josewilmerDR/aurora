...
const ALL_MODULES = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Asistencia diaria', to: '/hr/asistencia', icon: FiCalendar, minRole: 'encargado', draftKey: 'asistencia' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Presupuestos', to: '/finance/budgets', icon: FiDollarSign, minRole: 'encargado' },
      { label: 'Tesorería', to: '/finance/treasury', icon: FiActivity, minRole: 'encargado' },
      { label: 'Ingresos', to: '/finance/income', icon: FiDollarSign, minRole: 'encargado' },
      { label: 'Compradores', to: '/finance/buyers', icon: FiUsers, minRole: 'encargado' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Lista de Labores', to: '/admin/labores', icon: FiList, minRole: 'supervisor', draftKey: 'labor-form' },
      { label: 'Unidades de Medida', to: '/admin/unidades-medida', icon: FiPackage, minRole: 'supervisor', draftKey: 'unidad-form' },
      { label: 'Parámetros del Sistema', to: '/admin/parametros', icon: FiSliders, minRole: 'administrador' },
