...
const STEPS_DEF = [
  ...
  { key: 'paqueteApp',   visitKey: 'paqueteApp',   label: 'Crea un paquete de aplicaciones',      to: '/packages',                        icon: FiPackage,       description: 'Crea y reúne una o varias aplicaciones que se asignan a un grupo de bloques homogéneos.' },
  { key: 'paqueteMon',   visitKey: 'paqueteMon',   label: 'Crea un paquete de muestreos',         to: '/monitoreo/paquetes',              icon: FiClipboard,     description: 'Crea y reúne uno o varios muestreos que se asignan a un grupo de bloques homogéneos.' },
