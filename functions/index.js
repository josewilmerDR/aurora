...
app.delete('/api/monitoreo/:id/registros/:regIdx', authenticate, async (req, res) => {
  try {
...
app.get('/api/costos/live', authenticate, async (req, res) => {
  try {
...
app.get('/api/costos/indirectos', authenticate, async (req, res) => {
  try {
...
app.post('/api/costos/indirectos', authenticate, async (req, res) => {
  try {
...
app.put('/api/costos/indirectos/:id', authenticate, async (req, res) => {
  try {
...
app.delete('/api/costos/indirectos/:id', authenticate, async (req, res) => {
  try {
    const ownership = await verifyOwnership('costos_indirectos', req.params.id, req.fincaId);
    if (!ownership.ok) return res.status(ownership.status).json({ message: ownership.message });
...
app.get('/api/costos/snapshots', authenticate, async (req, res) => {
  try {
...
app.get('/api/costos/snapshots/:id', authenticate, async (req, res) => {
  try {
...
app.post('/api/costos/snapshots', authenticate, async (req, res) => {
  try {
...
app.delete('/api/costos/snapshots/:id', authenticate, async (req, res) => {
  try {
    const ownership = await verifyOwnership('costos_snapshots', req.params.id, req.fincaId);
    if (!ownership.ok) return res.status(ownership.status).json({ message: ownership.message });
