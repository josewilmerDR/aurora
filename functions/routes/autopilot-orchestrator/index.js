...
router.post('/api/autopilot/orchestrator/chains/plan', authenticate, planHandler);
router.post('/api/autopilot/orchestrator/chains/:id/execute', authenticate, executeHandler);
