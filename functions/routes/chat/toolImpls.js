...
// Mirrors the cross-field rules in functions/routes/users.js validateUserPayload.
// The chat tool writes directly to Firestore (it does not go through the HTTP
// route), so the same invariants are enforced here to prevent the agent from
// creating malformed docs that would later break UserManagement/EmployeeProfile.
