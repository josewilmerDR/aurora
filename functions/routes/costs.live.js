// Agregación en vivo del Centro de Costos. Extraído de costs.js para mantener
// el router bajo el presupuesto de <500 LOC (docs/code-standards.md §1): este
// handler une 10 colecciones y construye el desglose por lote/grupo/bloque, así
// que vive solo. El router (costs.js) lo monta con auth + rol + rate limit.
